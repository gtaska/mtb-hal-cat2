...
static cyhal_tcpwm_input_t _cyhal_translate_input_signal(cyhal_pwm_input_t signal)
{
    switch(signal)
    {
...
static cyhal_tcpwm_output_t _cyhal_translate_output_signal(cyhal_pwm_output_t signal)
{
    switch(signal)
    {
