...
#if defined(_GPIO_PSOC4000S_24_QFN_H_)
...
const cyhal_resource_pin_mapping_t cyhal_pin_map_scb_uart_rts[3] = {
...
const cyhal_resource_pin_mapping_t cyhal_pin_map_tcpwm_line_compl[4] = {
