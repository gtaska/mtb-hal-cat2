/***************************************************************************//**
* \file cyhal_psoc4100s_48_tqfp.h
*
* \brief
* PSoC4100S device GPIO HAL header for 48-TQFP package
*
* \note
...
#ifndef _CYHAL_PSOC4100S_48_TQFP_H_
#define _CYHAL_PSOC4100S_48_TQFP_H_

#include "cyhal_hw_resources.h"

/**
 * \addtogroup group_hal_impl_pin_package_psoc4100s_48_tqfp PSoC4100S 48-TQFP
...
/** Definitions for all of the pins that are bonded out on in the 48-TQFP package for the PSoC4100S series. */
typedef enum {
...
} cyhal_gpio_psoc4100s_48_tqfp_t;

/** Create generic name for the series/package specific type. */
typedef cyhal_gpio_psoc4100s_48_tqfp_t cyhal_gpio_t;
...
extern const cyhal_resource_pin_mapping_t cyhal_pin_map_scb_uart_tx[6];
...
extern const cyhal_resource_pin_mapping_t cyhal_pin_map_tcpwm_line[10];
...
extern const cyhal_resource_pin_mapping_t cyhal_pin_map_tcpwm_line_compl[9];
...
#endif /* _CYHAL_PSOC4100S_48_TQFP_H_ */
