/***************************************************************************//**
* \file cyhal_psoc4100s_44_tqfp.h
*
* \brief
* PSoC4100S device GPIO HAL header for 44-TQFP package
*
* \note
...
#ifndef _CYHAL_PSOC4100S_44_TQFP_H_
#define _CYHAL_PSOC4100S_44_TQFP_H_

#include "cyhal_hw_resources.h"

/**
 * \addtogroup group_hal_impl_pin_package_psoc4100s_44_tqfp PSoC4100S 44-TQFP
...
/** Definitions for all of the pins that are bonded out on in the 44-TQFP package for the PSoC4100S series. */
typedef enum {
...
} cyhal_gpio_psoc4100s_44_tqfp_t;

/** Create generic name for the series/package specific type. */
typedef cyhal_gpio_psoc4100s_44_tqfp_t cyhal_gpio_t;
...
#endif /* _CYHAL_PSOC4100S_44_TQFP_H_ */
