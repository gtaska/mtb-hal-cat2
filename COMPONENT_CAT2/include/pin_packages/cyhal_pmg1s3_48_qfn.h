...
#ifndef _CYHAL_PMG1S3_48_QFN_H_
#define _CYHAL_PMG1S3_48_QFN_H_

#include "cyhal_hw_resources.h"

/**
 * \addtogroup group_hal_impl_pin_package_pmg1s3_48_qfn PMG1S3 48-QFN
 * \ingroup group_hal_impl_pin_package
 * \{
 * Pin definitions and connections specific to the PMG1S3 48-QFN package.
 */
...
/** Definitions for all of the pins that are bonded out on in the 48-QFN package for the PMG1S3 series. */
typedef enum {
...
} cyhal_gpio_pmg1s3_48_qfn_t;

/** Create generic name for the series/package specific type. */
typedef cyhal_gpio_pmg1s3_48_qfn_t cyhal_gpio_t;
