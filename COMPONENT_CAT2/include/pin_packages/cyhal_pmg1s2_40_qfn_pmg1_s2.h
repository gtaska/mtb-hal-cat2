/***************************************************************************//**
* \file cyhal_pmg1s2_40_qfn_pmg1_s2.h
*
* \brief
...
#ifndef _CYHAL_PMG1S2_40_QFN_PMG1_S2_H_
#define _CYHAL_PMG1S2_40_QFN_PMG1_S2_H_

#include "cyhal_hw_resources.h"

/**
 * \addtogroup group_hal_impl_pin_package_pmg1s2_40_qfn_pmg1_s2 PMG1S2 40-QFN-PMG1-S2
...
/** Definitions for all of the pins that are bonded out on in the 40-QFN-PMG1-S2 package for the PMG1S2 series. */
typedef enum {
...
} cyhal_gpio_pmg1s2_40_qfn_pmg1_s2_t;

/** Create generic name for the series/package specific type. */
typedef cyhal_gpio_pmg1s2_40_qfn_pmg1_s2_t cyhal_gpio_t;
...
#define CYHAL_PIN_MAP_USBPD_AUXN_IO
...
#define CYHAL_PIN_MAP_USBPD_AUXP_IO
...
#define CYHAL_PIN_MAP_USBPD_CMP_OUT
...
#define CYHAL_PIN_MAP_USBPD_SBU1_IO
...
#define CYHAL_PIN_MAP_USBPD_SBU2_IO
...
#endif /* _CYHAL_PMG1S2_40_QFN_PMG1_S2_H_ */
