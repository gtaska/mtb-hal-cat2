/***************************************************************************//**
* \file cyhal_psoc4100smax_100_tqfp.h
*
* \brief
...
#ifndef _CYHAL_PSOC4100SMAX_100_TQFP_H_
#define _CYHAL_PSOC4100SMAX_100_TQFP_H_

#include "cyhal_hw_resources.h"

/**
 * \addtogroup group_hal_impl_pin_package_psoc4100smax_100_tqfp PSoC4100Smax 100-TQFP
...
/** Definitions for all of the pins that are bonded out on in the 100-TQFP package for the PSoC4100Smax series. */
typedef enum {
...
} cyhal_gpio_psoc4100smax_100_tqfp_t;

/** Create generic name for the series/package specific type. */
typedef cyhal_gpio_psoc4100smax_100_tqfp_t cyhal_gpio_t;
...
extern const cyhal_resource_pin_mapping_t cyhal_pin_map_lpcomp_comp[8];
...
extern const cyhal_resource_pin_mapping_t cyhal_pin_map_scb_i2c_scl[16];
...
extern const cyhal_resource_pin_mapping_t cyhal_pin_map_scb_spi_m_clk[15];
...
extern const cyhal_resource_pin_mapping_t cyhal_pin_map_scb_spi_m_select0[15];
...
extern const cyhal_resource_pin_mapping_t cyhal_pin_map_scb_spi_s_clk[15];
...
extern const cyhal_resource_pin_mapping_t cyhal_pin_map_scb_spi_s_select0[15];
...
extern const cyhal_resource_pin_mapping_t cyhal_pin_map_scb_uart_rx[14];
...
extern const cyhal_resource_pin_mapping_t cyhal_pin_map_tcpwm_line[36];
...
extern const cyhal_resource_pin_mapping_t cyhal_pin_map_tcpwm_line_compl[35];
...
#endif /* _CYHAL_PSOC4100SMAX_100_TQFP_H_ */
