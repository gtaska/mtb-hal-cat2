/***************************************************************************//**
* \file cyhal_psoc4100s_28_ssop_auto.h
*
* \brief
* PSoC4100S device GPIO HAL header for 28-SSOP-AUTO package
*
* \note
...
#ifndef _CYHAL_PSOC4100S_28_SSOP_AUTO_H_
#define _CYHAL_PSOC4100S_28_SSOP_AUTO_H_

#include "cyhal_hw_resources.h"

/**
 * \addtogroup group_hal_impl_pin_package_psoc4100s_28_ssop_auto PSoC4100S 28-SSOP-AUTO
...
/** Definitions for all of the pins that are bonded out on in the 28-SSOP-AUTO package for the PSoC4100S series. */
typedef enum {
...
} cyhal_gpio_psoc4100s_28_ssop_auto_t;

/** Create generic name for the series/package specific type. */
typedef cyhal_gpio_psoc4100s_28_ssop_auto_t cyhal_gpio_t;
...
extern const cyhal_resource_pin_mapping_t cyhal_pin_map_opamp_dsi_ctb_cmp[1];
...
extern const cyhal_resource_pin_mapping_t cyhal_pin_map_pass_dsi_sar_data[10];
...
extern const cyhal_resource_pin_mapping_t cyhal_pin_map_scb_uart_rx[3];
...
extern const cyhal_resource_pin_mapping_t cyhal_pin_map_tcpwm_tr_in[4];
...
#endif /* _CYHAL_PSOC4100S_28_SSOP_AUTO_H_ */
