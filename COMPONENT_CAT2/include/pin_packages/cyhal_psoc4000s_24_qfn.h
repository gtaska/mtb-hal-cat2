/***************************************************************************//**
* \file cyhal_psoc4000s_24_qfn.h
*
* \brief
* PSoC4000S device GPIO HAL header for 24-QFN package
*
* \note
...
#ifndef _CYHAL_PSOC4000S_24_QFN_H_
#define _CYHAL_PSOC4000S_24_QFN_H_

#include "cyhal_hw_resources.h"

/**
 * \addtogroup group_hal_impl_pin_package_psoc4000s_24_qfn PSoC4000S 24-QFN
...
/** Definitions for all of the pins that are bonded out on in the 24-QFN package for the PSoC4000S series. */
typedef enum {
...
} cyhal_gpio_psoc4000s_24_qfn_t;

/** Create generic name for the series/package specific type. */
typedef cyhal_gpio_psoc4000s_24_qfn_t cyhal_gpio_t;
...
extern const cyhal_resource_pin_mapping_t cyhal_pin_map_lpcomp_in_n[1];
...
extern const cyhal_resource_pin_mapping_t cyhal_pin_map_lpcomp_in_p[1];
...
#endif /* _CYHAL_PSOC4000S_24_QFN_H_ */
