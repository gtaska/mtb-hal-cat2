...
#ifndef _CYHAL_PMG1S3_97_BGA_H_
#define _CYHAL_PMG1S3_97_BGA_H_

#include "cyhal_hw_resources.h"

/**
 * \addtogroup group_hal_impl_pin_package_pmg1s3_97_bga PMG1S3 97-BGA
 * \ingroup group_hal_impl_pin_package
 * \{
 * Pin definitions and connections specific to the PMG1S3 97-BGA package.
 */
...
/** Definitions for all of the pins that are bonded out on in the 97-BGA package for the PMG1S3 series. */
typedef enum {
    ...
    VSSD_10 = CYHAL_GET_GPIO(CYHAL_PORT_8, 2), //!< Port 8 Pin 2
} cyhal_gpio_pmg1s3_97_bga_t;

/** Create generic name for the series/package specific type. */
typedef cyhal_gpio_pmg1s3_97_bga_t cyhal_gpio_t;
