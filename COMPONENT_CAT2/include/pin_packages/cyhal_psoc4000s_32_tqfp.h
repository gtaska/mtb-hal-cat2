/***************************************************************************//**
* \file cyhal_psoc4000s_32_tqfp.h
*
* \brief
* PSoC4000S device GPIO HAL header for 32-TQFP package
*
* \note
...
#ifndef _CYHAL_PSOC4000S_32_TQFP_H_
#define _CYHAL_PSOC4000S_32_TQFP_H_

#include "cyhal_hw_resources.h"

/**
 * \addtogroup group_hal_impl_pin_package_psoc4000s_32_tqfp PSoC4000S 32-TQFP
...
/** Definitions for all of the pins that are bonded out on in the 32-TQFP package for the PSoC4000S series. */
typedef enum {
...
} cyhal_gpio_psoc4000s_32_tqfp_t;

/** Create generic name for the series/package specific type. */
typedef cyhal_gpio_psoc4000s_32_tqfp_t cyhal_gpio_t;
...
#endif /* _CYHAL_PSOC4000S_32_TQFP_H_ */
