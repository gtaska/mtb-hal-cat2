/***************************************************************************//**
* \file cyhal_psoc4100sp256kb_64_tqfp_mc.h
*
* \brief
...
#ifndef _CYHAL_PSOC4100SP256KB_64_TQFP_MC_H_
#define _CYHAL_PSOC4100SP256KB_64_TQFP_MC_H_

#include "cyhal_hw_resources.h"

/**
 * \addtogroup group_hal_impl_pin_package_psoc4100sp256kb_64_tqfp_mc PSoC4100Sp256KB 64-TQFP-MC
...
/** Definitions for all of the pins that are bonded out on in the 64-TQFP-MC package for the PSoC4100Sp256KB series. */
typedef enum {
...
} cyhal_gpio_psoc4100sp256kb_64_tqfp_mc_t;

/** Create generic name for the series/package specific type. */
typedef cyhal_gpio_psoc4100sp256kb_64_tqfp_mc_t cyhal_gpio_t;
...
extern const cyhal_resource_pin_mapping_t cyhal_pin_map_lpcomp_comp[6];
...
extern const cyhal_resource_pin_mapping_t cyhal_pin_map_opamp_dsi_ctb_cmp[4];
...
extern const cyhal_resource_pin_mapping_t cyhal_pin_map_opamp_vin_m[3];
...
extern const cyhal_resource_pin_mapping_t cyhal_pin_map_opamp_vin_p0[3];
...
extern const cyhal_resource_pin_mapping_t cyhal_pin_map_pass_dsi_sar_data[24];
...
extern const cyhal_resource_pin_mapping_t cyhal_pin_map_pass_dsi_sar_data_valid[2];
...
extern const cyhal_resource_pin_mapping_t cyhal_pin_map_pass_dsi_sar_sample_done[2];
...
extern const cyhal_resource_pin_mapping_t cyhal_pin_map_pass_sar_ext_vref0[2];
...
extern const cyhal_resource_pin_mapping_t cyhal_pin_map_pass_sar_ext_vref1[2];
...
extern const cyhal_resource_pin_mapping_t cyhal_pin_map_pass_tr_sar_out[2];
...
extern const cyhal_resource_pin_mapping_t cyhal_pin_map_scb_i2c_scl[11];
...
extern const cyhal_resource_pin_mapping_t cyhal_pin_map_tcpwm_line[20];
...
#endif /* _CYHAL_PSOC4100SP256KB_64_TQFP_MC_H_ */
