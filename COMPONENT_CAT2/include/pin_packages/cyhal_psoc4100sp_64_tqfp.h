/***************************************************************************//**
* \file cyhal_psoc4100sp_64_tqfp.h
*
* \brief
...
#ifndef _CYHAL_PSOC4100SP_64_TQFP_H_
#define _CYHAL_PSOC4100SP_64_TQFP_H_

#include "cyhal_hw_resources.h"

/**
 * \addtogroup group_hal_impl_pin_package_psoc4100sp_64_tqfp PSoC4100Sp 64-TQFP
...
/** Definitions for all of the pins that are bonded out on in the 64-TQFP package for the PSoC4100Sp series. */
typedef enum {
...
} cyhal_gpio_psoc4100sp_64_tqfp_t;

/** Create generic name for the series/package specific type. */
typedef cyhal_gpio_psoc4100sp_64_tqfp_t cyhal_gpio_t;
...
extern const cyhal_resource_pin_mapping_t cyhal_pin_map_tcpwm_line_compl[19];
...
#endif /* _CYHAL_PSOC4100SP_64_TQFP_H_ */
