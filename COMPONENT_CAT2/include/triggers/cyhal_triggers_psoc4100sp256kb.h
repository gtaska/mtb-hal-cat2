...
typedef enum
{
    ...
    _CYHAL_TRIGGER_CSD_DSI_SENSE_OUT = 9, //!< csd.dsi_sense_out
    _CYHAL_TRIGGER_CSD_TR_ADC_DONE = 10, //!< csd.tr_adc_done
    _CYHAL_TRIGGER_EXCO_TRIGGER = 11, //!< exco.trigger
    ...
    _CYHAL_TRIGGER_PASS1_DSI_CTB_CMP0 = 15, //!< pass[1].dsi_ctb_cmp0
    _CYHAL_TRIGGER_PASS0_DSI_CTB_CMP1 = 16, //!< pass[0].dsi_ctb_cmp1
    _CYHAL_TRIGGER_PASS1_DSI_CTB_CMP1 = 17, //!< pass[1].dsi_ctb_cmp1
    _CYHAL_TRIGGER_PASS0_DSI_SAR_SAMPLE_DONE = 18, //!< pass[0].dsi_sar_sample_done
    _CYHAL_TRIGGER_PASS1_DSI_SAR_SAMPLE_DONE = 19, //!< pass[1].dsi_sar_sample_done
    _CYHAL_TRIGGER_PASS0_TR_SAR_OUT = 20, //!< pass[0].tr_sar_out
    _CYHAL_TRIGGER_PASS1_TR_SAR_OUT = 21, //!< pass[1].tr_sar_out
    _CYHAL_TRIGGER_SCB0_TR_RX_REQ = 22, //!< scb[0].tr_rx_req
    _CYHAL_TRIGGER_SCB1_TR_RX_REQ = 23, //!< scb[1].tr_rx_req
    _CYHAL_TRIGGER_SCB2_TR_RX_REQ = 24, //!< scb[2].tr_rx_req
    _CYHAL_TRIGGER_SCB3_TR_RX_REQ = 25, //!< scb[3].tr_rx_req
    _CYHAL_TRIGGER_SCB4_TR_RX_REQ = 26, //!< scb[4].tr_rx_req
    _CYHAL_TRIGGER_SCB0_TR_TX_REQ = 27, //!< scb[0].tr_tx_req
    _CYHAL_TRIGGER_SCB1_TR_TX_REQ = 28, //!< scb[1].tr_tx_req
    _CYHAL_TRIGGER_SCB2_TR_TX_REQ = 29, //!< scb[2].tr_tx_req
    _CYHAL_TRIGGER_SCB3_TR_TX_REQ = 30, //!< scb[3].tr_tx_req
    _CYHAL_TRIGGER_SCB4_TR_TX_REQ = 31, //!< scb[4].tr_tx_req
    _CYHAL_TRIGGER_TCPWM_LINE0 = 32, //!< tcpwm.line[0]
    _CYHAL_TRIGGER_TCPWM_LINE1 = 33, //!< tcpwm.line[1]
    _CYHAL_TRIGGER_TCPWM_LINE2 = 34, //!< tcpwm.line[2]
    _CYHAL_TRIGGER_TCPWM_LINE3 = 35, //!< tcpwm.line[3]
    _CYHAL_TRIGGER_TCPWM_LINE4 = 36, //!< tcpwm.line[4]
    _CYHAL_TRIGGER_TCPWM_LINE5 = 37, //!< tcpwm.line[5]
    _CYHAL_TRIGGER_TCPWM_LINE6 = 38, //!< tcpwm.line[6]
    _CYHAL_TRIGGER_TCPWM_LINE7 = 39, //!< tcpwm.line[7]
    _CYHAL_TRIGGER_TCPWM_TR_COMPARE_MATCH0 = 40, //!< tcpwm.tr_compare_match[0]
    _CYHAL_TRIGGER_TCPWM_TR_COMPARE_MATCH1 = 41, //!< tcpwm.tr_compare_match[1]
    _CYHAL_TRIGGER_TCPWM_TR_COMPARE_MATCH2 = 42, //!< tcpwm.tr_compare_match[2]
    _CYHAL_TRIGGER_TCPWM_TR_COMPARE_MATCH3 = 43, //!< tcpwm.tr_compare_match[3]
    _CYHAL_TRIGGER_TCPWM_TR_COMPARE_MATCH4 = 44, //!< tcpwm.tr_compare_match[4]
    _CYHAL_TRIGGER_TCPWM_TR_COMPARE_MATCH5 = 45, //!< tcpwm.tr_compare_match[5]
    _CYHAL_TRIGGER_TCPWM_TR_COMPARE_MATCH6 = 46, //!< tcpwm.tr_compare_match[6]
    _CYHAL_TRIGGER_TCPWM_TR_COMPARE_MATCH7 = 47, //!< tcpwm.tr_compare_match[7]
    _CYHAL_TRIGGER_TCPWM_TR_OVERFLOW0 = 48, //!< tcpwm.tr_overflow[0]
    _CYHAL_TRIGGER_TCPWM_TR_OVERFLOW1 = 49, //!< tcpwm.tr_overflow[1]
    _CYHAL_TRIGGER_TCPWM_TR_OVERFLOW2 = 50, //!< tcpwm.tr_overflow[2]
    _CYHAL_TRIGGER_TCPWM_TR_OVERFLOW3 = 51, //!< tcpwm.tr_overflow[3]
    _CYHAL_TRIGGER_TCPWM_TR_OVERFLOW4 = 52, //!< tcpwm.tr_overflow[4]
    _CYHAL_TRIGGER_TCPWM_TR_OVERFLOW5 = 53, //!< tcpwm.tr_overflow[5]
    _CYHAL_TRIGGER_TCPWM_TR_OVERFLOW6 = 54, //!< tcpwm.tr_overflow[6]
    _CYHAL_TRIGGER_TCPWM_TR_OVERFLOW7 = 55, //!< tcpwm.tr_overflow[7]
    _CYHAL_TRIGGER_TCPWM_TR_UNDERFLOW0 = 56, //!< tcpwm.tr_underflow[0]
    _CYHAL_TRIGGER_TCPWM_TR_UNDERFLOW1 = 57, //!< tcpwm.tr_underflow[1]
    _CYHAL_TRIGGER_TCPWM_TR_UNDERFLOW2 = 58, //!< tcpwm.tr_underflow[2]
    _CYHAL_TRIGGER_TCPWM_TR_UNDERFLOW3 = 59, //!< tcpwm.tr_underflow[3]
    _CYHAL_TRIGGER_TCPWM_TR_UNDERFLOW4 = 60, //!< tcpwm.tr_underflow[4]
    _CYHAL_TRIGGER_TCPWM_TR_UNDERFLOW5 = 61, //!< tcpwm.tr_underflow[5]
    _CYHAL_TRIGGER_TCPWM_TR_UNDERFLOW6 = 62, //!< tcpwm.tr_underflow[6]
    _CYHAL_TRIGGER_TCPWM_TR_UNDERFLOW7 = 63, //!< tcpwm.tr_underflow[7]
} _cyhal_trigger_source_psoc4100sp256kb_t;

/** Typedef for internal device family specific trigger source to generic trigger source */
typedef _cyhal_trigger_source_psoc4100sp256kb_t cyhal_internal_source_t;

/** @brief Get a public source signal type (cyhal_trigger_source_psoc4100sp256kb_t) given an internal source signal and signal type */
#define _CYHAL_TRIGGER_CREATE_SOURCE(src, type)    ((src) << 1 | (type))
/** @brief Get an internal source signal (_cyhal_trigger_source_psoc4100sp256kb_t) given a public source signal. */
...
typedef enum
{
    ...
    CYHAL_TRIGGER_PASS1_DSI_CTB_CMP0_EDGE = _CYHAL_TRIGGER_CREATE_SOURCE(_CYHAL_TRIGGER_PASS1_DSI_CTB_CMP0, CYHAL_SIGNAL_TYPE_EDGE), //!< pass[1].dsi_ctb_cmp0
    CYHAL_TRIGGER_PASS1_DSI_CTB_CMP0_LEVEL = _CYHAL_TRIGGER_CREATE_SOURCE(_CYHAL_TRIGGER_PASS1_DSI_CTB_CMP0, CYHAL_SIGNAL_TYPE_LEVEL), //!< pass[1].dsi_ctb_cmp0
    ...
    CYHAL_TRIGGER_PASS1_DSI_CTB_CMP1_EDGE = _CYHAL_TRIGGER_CREATE_SOURCE(_CYHAL_TRIGGER_PASS1_DSI_CTB_CMP1, CYHAL_SIGNAL_TYPE_EDGE), //!< pass[1].dsi_ctb_cmp1
    CYHAL_TRIGGER_PASS1_DSI_CTB_CMP1_LEVEL = _CYHAL_TRIGGER_CREATE_SOURCE(_CYHAL_TRIGGER_PASS1_DSI_CTB_CMP1, CYHAL_SIGNAL_TYPE_LEVEL), //!< pass[1].dsi_ctb_cmp1
    ...
    CYHAL_TRIGGER_PASS1_DSI_SAR_SAMPLE_DONE_EDGE = _CYHAL_TRIGGER_CREATE_SOURCE(_CYHAL_TRIGGER_PASS1_DSI_SAR_SAMPLE_DONE, CYHAL_SIGNAL_TYPE_EDGE), //!< pass[1].dsi_sar_sample_done
    CYHAL_TRIGGER_PASS1_DSI_SAR_SAMPLE_DONE_LEVEL = _CYHAL_TRIGGER_CREATE_SOURCE(_CYHAL_TRIGGER_PASS1_DSI_SAR_SAMPLE_DONE, CYHAL_SIGNAL_TYPE_LEVEL), //!< pass[1].dsi_sar_sample_done
    ...
    CYHAL_TRIGGER_PASS1_TR_SAR_OUT_EDGE = _CYHAL_TRIGGER_CREATE_SOURCE(_CYHAL_TRIGGER_PASS1_TR_SAR_OUT, CYHAL_SIGNAL_TYPE_EDGE), //!< pass[1].tr_sar_out
    CYHAL_TRIGGER_PASS1_TR_SAR_OUT_LEVEL = _CYHAL_TRIGGER_CREATE_SOURCE(_CYHAL_TRIGGER_PASS1_TR_SAR_OUT, CYHAL_SIGNAL_TYPE_LEVEL), //!< pass[1].tr_sar_out
...
#define CYHAL_TRIGGER_PASS1_DSI_CTB_CMP0 (CYHAL_TRIGGER_PASS1_DSI_CTB_CMP0_LEVEL) //!< Legacy define. Instead, use the explicit _LEVEL or _EDGE version.
...
#define CYHAL_TRIGGER_PASS1_DSI_CTB_CMP1 (CYHAL_TRIGGER_PASS1_DSI_CTB_CMP1_LEVEL) //!< Legacy define. Instead, use the explicit _LEVEL or _EDGE version.
...
#define CYHAL_TRIGGER_PASS1_DSI_SAR_SAMPLE_DONE (CYHAL_TRIGGER_PASS1_DSI_SAR_SAMPLE_DONE_LEVEL) //!< Legacy define. Instead, use the explicit _LEVEL or _EDGE version.
...
#define CYHAL_TRIGGER_PASS1_TR_SAR_OUT (CYHAL_TRIGGER_PASS1_TR_SAR_OUT_LEVEL) //!< Legacy define. Instead, use the explicit _LEVEL or _EDGE version.
...
extern const _cyhal_trigger_source_psoc4100sp256kb_t* cyhal_mux_to_sources [5];
